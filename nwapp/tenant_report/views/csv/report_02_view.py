...
def report_02_streaming_csv_view(request):
    ...
    for area_coordinator in area_coordinators.all():
    #
    ...
    #     # Generate our row.
        rows += ([
            area_coordinator.user_id,
            str(area_coordinator),
            str(area_coordinator.user.member.watch.district.name),
            area_coordinator.user.email,
            str(area_coordinator.user.member.contact.primary_phone),
            str(area_coordinator.user.member.watch),
            pretty_dt_string(area_coordinator.user.created_at),
