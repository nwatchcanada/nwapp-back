...
class CanListCreateAreaCoordinatorMetricPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAreaCoordinatorMetricPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
