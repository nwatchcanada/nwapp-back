...
class CanListCreateAreaCoordinatorPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAreaCoordinatorPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
