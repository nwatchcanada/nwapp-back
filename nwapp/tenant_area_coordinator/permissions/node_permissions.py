...
class CanListCreateAreaCoordinatorNodePermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAreaCoordinatorNodePermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
