...
class CanListCreateAreaCoordinatorCommentPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAreaCoordinatorCommentPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
