...
from tenant_area_coordinator.permissions import CanRetrieveUpdateDestroyAreaCoordinatorMetricPermission
...
class AreaCoordinatorMetricUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = (
        ...
        TenantPermission,
        CanRetrieveUpdateDestroyAreaCoordinatorMetricPermission
    )
    ...
    def put(self, request, slug=None):
        ...
        Update
        """
        object = get_object_or_404(AreaCoordinatorMetric, area_coordinator__user__slug=slug)
