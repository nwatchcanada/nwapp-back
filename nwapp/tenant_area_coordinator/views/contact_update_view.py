...
from tenant_area_coordinator.tasks import geoip2_area_coordinator_contact_audit_func
...
class AreaCoordinatorContactUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, slug=None):
        ...
        django_rq.enqueue(geoip2_area_coordinator_contact_audit_func, request.tenant, object)
