...
from tenant_area_coordinator.permissions import CanRetrieveUpdateDestroyAreaCoordinatorAddressPermission
...
class AreaCoordinatorAddressUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = (
        ...
        TenantPermission,
        CanRetrieveUpdateDestroyAreaCoordinatorAddressPermission
    )
    ...
    def put(self, request, slug=None):
        ...
        Update
        """
        object = get_object_or_404(AreaCoordinatorAddress, area_coordinator__user__slug=slug)
