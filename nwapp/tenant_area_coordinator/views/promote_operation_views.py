...
class AreaCoordinatorPromoteOperationAPIView(generics.CreateAPIView):
    serializer_class = AreaCoordinatorPromoteOperationSerializer
    permission_classes = (
    ...
    def post(self, request, format=None):
        ...
        django_rq.enqueue(geoip2_area_coordinator_address_audit_func, request.tenant, area_coordinator)
