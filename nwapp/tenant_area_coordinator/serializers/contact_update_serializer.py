...
class AreaCoordinatorContactUpdateSerializer(serializers.Serializer):
    # ------ MEMBER CONTACT ------ #
    ...
    def update(self, instance, validated_data):
        ...
        if instance.area_coordinator.type_of != AreaCoordinator.MEMBER_TYPE_OF.BUSINESS:
            ...
            instance.organization_type_of = AreaCoordinatorContact.MEMBER_ORGANIZATION_TYPE_OF.UNSPECIFIED
