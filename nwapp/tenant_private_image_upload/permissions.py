...
class CanListCreatePrivateImageUploadPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyPrivateImageUploadPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
