...
class PrivateImageUploadFilter(django_filters.FilterSet):
    ...
    #     return PrivateImageUpload.objects.search(value).order_by('contact__last_name')
    #
    ...
    # #     # (d) If an PrivateImageUpload has an active Announcement attached to them,
    ...
    # #
    # # def keyword_filtering(self, queryset, name, value):
    # #     return PrivateImageUpload.objects.partial_text_search(value)
    # #
    # # search = django_filters.CharFilter(method='keyword_filtering')
    # #
