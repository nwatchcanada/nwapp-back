...
class TenantProfileRetrieveUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    authentication_classes= (OAuth2Authentication,)
    serializer_class = TenantProfileInfoRetrieveUpdateSerializer
    ...
    def get(self, request):
        ...
        serializer = TenantProfileInfoRetrieveUpdateSerializer(request.user, context={
    ...
    def post(self, request):
        ...
        serializer = TenantProfileInfoRetrieveUpdateSerializer(request.user, data=request.data, context={
            'authenticated_by': request.user,
            'authenticated_from': request.client_ip,
            'authenticated_from_is_public': request.client_ip_is_routable,
            'access_token': access_token,
