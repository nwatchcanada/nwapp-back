...
from tenant_gateway.serializers import TenantLogoutSerializer


class TenantLogoutAPIView(APIView):
    """
    ...
    def post(self, request):
        ...
        serializer = TenantLogoutSerializer(data=request.data, context={
