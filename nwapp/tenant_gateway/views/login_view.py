...
from tenant_gateway.serializers import TenantLoginSerializer, TenantProfileInfoRetrieveUpdateSerializer
...
class TenantLoginAPIView(APIView):
    ...
    def post(self, request):
        ...
        serializer = TenantLoginSerializer(data=request.data, context={
            'request': request,
        })
        ...
        serializer = TenantProfileInfoRetrieveUpdateSerializer(request.user, many=False, context={
