...
class TaskItemFilter(django_filters.FilterSet):
    ...
    #     return TaskItem.objects.search(value).order_by('user__member__contact__last_name')
    #
    ...
    # #     # (d) If an TaskItem has an active Announcement attached to them,
    ...
    # #
    # # def keyword_filtering(self, queryset, name, value):
    # #     return TaskItem.objects.partial_text_search(value)
    # #
    # # search = django_filters.CharFilter(method='keyword_filtering')
    # #
