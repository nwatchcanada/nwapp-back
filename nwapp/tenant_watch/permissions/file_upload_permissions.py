...
class CanListCreateWatchFileUploadPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyWatchFileUploadPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if "GET" in request.method:
            # OWNERSHIP BASED
            if request.user == obj.watch.user:
                return True
