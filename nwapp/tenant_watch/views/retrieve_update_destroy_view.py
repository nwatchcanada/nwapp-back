...
class WatchRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = (
    ...
    def put(self, request, slug=None):
        ...
        write_serializer = WatchUpdateSerializer(object, data=request.data, context={'request': request,})
