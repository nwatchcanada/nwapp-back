...
from tenant_watch.serializers import WatchRetrieveSerializer, WatchInformationUpdateSerializer


class WatchInformationUpdateAPIView(generics.UpdateAPIView):
    permission_classes = (
    ...
    def put(self, request, slug=None):
        ...
        write_serializer = WatchInformationUpdateSerializer(object, data=request.data, context={'request': request,})
