...
urlpatterns = (
    # path('api/v1/watchs', WatchListCreateAPIView.as_view(), name='nwapp_watchs_list_create_api_endpoint'),
    ...
    # path('api/v1/watch/<slug>', WatchRetrieveAPIView.as_view(), name='nwapp_watchs_retrieve_api_endpoint'),
