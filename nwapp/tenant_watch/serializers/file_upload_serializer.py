...
class WatchFileUploadListCreateSerializer(serializers.ModelSerializer):
    watch = serializers.PrimaryKeyRelatedField(many=False, queryset=Watch.objects.all(), required=True,)
    ...
    def create(self, validated_data):
        ...
        """
        watch = validated_data.get('watch')
        ...
        # Attach our comment.
        #---------------------------
        text = _("A file named \"%(filename)s\" has been uploaded to this watch's record by %(name)s.") % {
