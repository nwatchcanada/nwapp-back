...
class WatchContactUpdateSerializer(serializers.Serializer):
    # ------ MEMBER CONTACT ------ #
    ...
    def update(self, instance, validated_data):
        ...
        if instance.watch.type_of != Watch.MEMBER_TYPE_OF.BUSINESS:
            ...
            instance.organization_type_of = WatchContact.MEMBER_ORGANIZATION_TYPE_OF.UNSPECIFIED

        instance.save()
        logger.info("Updated watch contact.")
