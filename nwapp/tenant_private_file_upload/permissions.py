...
class CanListCreatePrivateFileUploadPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyPrivateFileUploadPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
