...
urlpatterns = (
    ...
    path('api/v1/private-file-upload/<slug>', views.PrivateFileUploadRetrieveUpdateDestroyAPIView.as_view(), name='nwapp_private_file_upload_retrieve_update_delete_api_endpoint'),
)
