...
class PrivateFileUploadFilter(django_filters.FilterSet):
    ...
    #     return PrivateFileUpload.objects.search(value).order_by('contact__last_name')
    #
    ...
    # #     # (d) If an PrivateFileUpload has an active Announcement attached to them,
    ...
    # #
    # # def keyword_filtering(self, queryset, name, value):
    # #     return PrivateFileUpload.objects.partial_text_search(value)
    # #
    # # search = django_filters.CharFilter(method='keyword_filtering')
    # #
