...
from tenant_private_file_upload.permissions import CanRetrieveUpdateDestroyPrivateFileUploadPermission
from tenant_private_file_upload.serializers import (
    PrivateFileUploadRetrieveSerializer,
    PrivateFileUploadUpdateSerializer
)


class PrivateFileUploadRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = (
        DisableOptionsPermission,
        permissions.IsAuthenticated,
        SharedUserIsActivePermission,
        TenantPermission,
        CanRetrieveUpdateDestroyPrivateFileUploadPermission
    )
    ...
    def put(self, request, slug=None):
        ...
        write_serializer = PrivateFileUploadUpdateSerializer(object, data=request.data, context={'request': request,})
