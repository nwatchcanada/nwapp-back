...
from tenant_associate.serializers import AssociateDistrictOperationSerializer, AssociateRetrieveSerializer
from tenant_associate.tasks import geoip2_associate_audit_func


class AssociateDistrictOperationAPIView(generics.CreateAPIView):
    serializer_class = AssociateDistrictOperationSerializer
    permission_classes = (
    ...
    def post(self, request, format=None):
        write_serializer = AssociateDistrictOperationSerializer(
            data=request.data,
            context={
                'request': request
            }
