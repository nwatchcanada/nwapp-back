...
from tenant_associate.tasks import geoip2_associate_metric_audit_func
...
class AssociateMetricUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, slug=None):
        ...
        Update
        """
        object = get_object_or_404(AssociateMetric, member__user__slug=slug)
        ...
        django_rq.enqueue(geoip2_associate_metric_audit_func, request.tenant, object)
