...
class CanListCreateAssociateFileUploadPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAssociateFileUploadPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
