...
class CanListCreateAssociateContactPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAssociateContactPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
