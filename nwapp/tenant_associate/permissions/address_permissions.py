...
class CanListCreateAssociateAddressPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAssociateAddressPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
