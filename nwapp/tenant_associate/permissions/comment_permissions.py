...
class CanListCreateAssociateCommentPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyAssociateCommentPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
