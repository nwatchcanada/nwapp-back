...
class AssociateUpdateSerializer(serializers.Serializer):
    ...
    another_household_associate_registered = serializers.BooleanField(write_only=True,)
    ...
    def update(self, instance, validated_data):
        ...
        #     another_household_associate_registered=another_household_associate_registered,
        ...
        # )
        # logger.info("Updated associate metric.")
        #
        # # Attached our tags.
