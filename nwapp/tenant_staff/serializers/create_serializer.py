...
class StaffCreateSerializer(serializers.Serializer):
    ...
    def validate_organization_name(self, value):
        ...
        if type_of == Staff.MEMBER_TYPE_OF.BUSINESS:
    ...
    def create(self, validated_data):
        ...
        if type_of != Staff.MEMBER_TYPE_OF.BUSINESS:
            ...
            organization_type_of = StaffContact.MEMBER_ORGANIZATION_TYPE_OF.UNSPECIFIED
        ...
        logger.info("Created staff contact.")
        ...
        street_direction = validated_data.get('street_direction', StaffAddress.STREET_DIRECTION.NONE)
        ...
        logger.info("Created staff address.")
        ...
        logger.info("Created staff metric.")
