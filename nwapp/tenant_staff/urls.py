...
urlpatterns = (
    ...
    path('api/v1/staffs/operation/demote', StaffDemoteOperationAPIView.as_view(), name='nwapp_staffs_demote_operation_api_endpoint'),
    path('api/v1/staffs/operation/change-password', StaffChangePasswordOperationAPIView.as_view(), name='nwapp_staffs_change_password_operation_api_endpoint'),
