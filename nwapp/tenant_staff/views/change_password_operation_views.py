...
from tenant_staff.serializers import StaffChangePasswordOperationSerializer, StaffRetrieveSerializer
from tenant_staff.tasks import geoip2_staff_audit_func


class StaffChangePasswordOperationAPIView(generics.CreateAPIView):
    ...
    def post(self, request, format=None):
        write_serializer = StaffChangePasswordOperationSerializer(
            data=request.data,
            context={
                'request': request
            }
