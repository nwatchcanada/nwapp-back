...
from tenant_staff.permissions import CanRetrieveUpdateDestroyStaffMetricPermission
...
class StaffMetricUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = (
        ...
        TenantPermission,
        CanRetrieveUpdateDestroyStaffMetricPermission
    )
    ...
    def put(self, request, slug=None):
        ...
        Update
        """
        object = get_object_or_404(StaffMetric, staff__user__slug=slug)
