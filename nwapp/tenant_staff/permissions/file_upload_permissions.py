...
class CanListCreateStaffFileUploadPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyStaffFileUploadPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
