...
# )
from tenant_item.serializers import ItemRetrieveSerializer, ItemCategoryUpdateSerializer
from tenant_foundation.models import Item


class ItemCategoryUpdateAPIView(generics.UpdateAPIView):
    ...
    def put(self, request, slug=None):
        ...
        write_serializer = ItemCategoryUpdateSerializer(
            object,
            data=request.data,
            context={
                'request': request,
