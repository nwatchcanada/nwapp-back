...
# )
from tenant_item.serializers import ItemRetrieveSerializer, ItemAuthoritiesUpdateSerializer
from tenant_foundation.models import Item


class ItemAuthoritiesUpdateAPIView(generics.UpdateAPIView):
    ...
    def put(self, request, slug=None):
        ...
        write_serializer = ItemAuthoritiesUpdateSerializer(
            object,
            data=request.data,
            context={
                'request': request,
