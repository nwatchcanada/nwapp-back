...
from tenant_member.tasks import geocode_member_address_func, geoip2_member_contact_audit_func
...
class MemberContactUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, slug=None):
        ...
        django_rq.enqueue(geoip2_member_contact_audit_func, request.tenant, object)
