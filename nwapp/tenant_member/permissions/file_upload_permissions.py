...
class CanListCreateMemberFileUploadPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyMemberFileUploadPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
