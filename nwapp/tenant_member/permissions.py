...
class CanListCreateMemberRootPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyMemberRootPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
...
class CanListCreateMemberChildPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
...
class CanRetrieveUpdateDestroyMemberChildPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
