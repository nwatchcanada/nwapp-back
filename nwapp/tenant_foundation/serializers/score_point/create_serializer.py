...
class ScorePointCreateSerializer(serializers.Serializer):
    # ------ MEMBER ------ #
    ...
    #     allow_null=True,
    #     validators=[
    #         UniqueValidator(queryset=ScorePointContact.objects.all()),
    #     ],
    # )
    # organization_type_of = serializers.ChoiceField(
    #     required=False,
    #     allow_null=True,
    #     choices=ScorePointContact.MEMBER_ORGANIZATION_TYPE_OF_CHOICES,
    # )
    ...
    # street_type = serializers.ChoiceField(choices=ScorePointAddress.STREET_TYPE_CHOICES,)
    # street_type_other = serializers.CharField(required=False, allow_null=True, allow_blank=True,)
    # street_direction = serializers.ChoiceField(choices=ScorePointAddress.STREET_DIRECTION_CHOICES,)
    ...
    #     if type_of == ScorePoint.MEMBER_TYPE_OF.BUSINESS:
    ...
    def create(self, validated_data):
        ...
        #     organization_type_of = ScorePointContact.MEMBER_ORGANIZATION_TYPE_OF.UNSPECIFIED
        #
        # member_contact = ScorePointContact.objects.create(
        #     member=member,
        ...
        # street_direction = validated_data.get('street_direction', ScorePointAddress.STREET_DIRECTION.NONE)
        # postal_code = validated_data.get('postal_code', None)
        # member_address = ScorePointAddress.objects.create(
        #     member=member,
        #     country=country,
        #     region=region,
        #     locality=locality,
        ...
        #
        # member_metric = ScorePointMetric.objects.create(
        #     member=member,
