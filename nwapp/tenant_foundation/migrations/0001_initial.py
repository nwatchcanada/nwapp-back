# Generated by Django 2.2.7 on 2019-11-26 02:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('another_household_member_registered', models.BooleanField(blank=True, default=False, help_text='Is there another member of your household which is registered with us?', verbose_name='Another Household Member Registered?')),
                ...
                ('total_household_count', models.PositiveSmallIntegerField(blank=True, default=0, help_text='How many people are in your household?', verbose_name='Total Household Count')),
                ('under_18_years_household_count', models.PositiveSmallIntegerField(blank=True, default=0, help_text='How many people in your household are under the age of 18?', verbose_name='Under 18 Years Household Count')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_type', models.PositiveSmallIntegerField(choices=[(2, 'Avenue'), (3, 'Drive'), (4, 'Road'), (5, 'Street'), (6, 'Way')], help_text='Please select the street type.', verbose_name='Street Type')),
