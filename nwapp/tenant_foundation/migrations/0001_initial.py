# Generated by Django 3.0.4 on 2020-03-27 03:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('needs_geolocating', models.BooleanField(blank=True, default=True, help_text='Field controls if system need to geolocate the current address to get a new longitude and latitude coordinates. Any address change results in this field being changed to `True`.', verbose_name='Needs Geolocating')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('created_from', models.GenericIPAddressField(blank=True, help_text='The IP address of the creator.', null=True, verbose_name='Created from')),
                ('created_from_is_public', models.BooleanField(blank=True, default=False, help_text='Is creator a public IP and is routable.', verbose_name='Is the IP ')),
                ('last_modified_at', models.DateTimeField(auto_now=True)),
