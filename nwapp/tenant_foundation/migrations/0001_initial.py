    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of', models.PositiveSmallIntegerField(choices=[(1, 'Customer'), (2, 'Associate'), (3, 'Staff'), (4, 'Item'), (5, 'Watch'), (6, 'District'), (7, 'File')], db_index=True, help_text='The type of item this is.', verbose_name='Type of')),
