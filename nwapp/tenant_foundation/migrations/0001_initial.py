# Generated by Django 3.0.7 on 2020-08-06 04:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of', models.PositiveSmallIntegerField(choices=[(2, 'Business'), (1, 'Residential'), (3, 'Community Cares')], db_index=True, default=1, help_text='The type of area coordinator this is.', verbose_name='Type of')),
                ...
                ('demotion_reason', models.PositiveSmallIntegerField(blank=True, choices=[(2, 'Retired'), (3, 'Health'), (4, 'No longer wants role'), (5, 'Reprimand'), (1, 'Other (Please specify)')], help_text='The reason for the demotion.', null=True, verbose_name='Demotion Reason')),
                ...
                ('uuid', models.CharField(db_index=True, default=uuid.uuid4, editable=False, help_text='The unique identifier we want to release to the public to identify this unique record.', max_length=63, unique=True, verbose_name='UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_type', models.PositiveSmallIntegerField(choices=[(2, 'Avenue'), (3, 'Boulevard'), (4, 'Court'), (5, 'Crescent'), (6, 'Drive'), (7, 'Gate'), (8, 'Grove'), (9, 'Hill'), (10, 'Lane'), (11, 'Place'), (12, 'Road'), (13, 'Street'), (14, 'Terrace'), (15, 'Way'), (1, 'Other')], help_text='Please select the street type.', verbose_name='Street Type')),
