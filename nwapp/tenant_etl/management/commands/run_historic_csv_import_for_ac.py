...
class Command(BaseCommand):
    ...
    def begin_processing(self, schema_name, prefix):
        ...
        full_file_path = self.find_filepath_containing("Watch Area Coordinators", prefix)  # Personal Customers
